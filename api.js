...
(function() {
    ...
    var homeAnalyticsDataRanges = require("homeAnalyticsDataRanges.js");
    ...
    getConfig = function() {
        ...
        configs.forEach(function(config) {
            ...
            if (config.fieldName === DATA_RANGE) {
                config.valueSet = [homeAnalyticsDataRanges.HOURLY, homeAnalyticsDataRanges.DAILY,
                                    homeAnalyticsDataRanges.WEEKLY, homeAnalyticsDataRanges.MONTHLY, 
                                    homeAnalyticsDataRanges.YEARLY, homeAnalyticsDataRanges.ALL];
            }
            if (config.fieldName === DATA_ORDER) {
                config.valueSet = [homeAnalyticsDataRanges.NONE, homeAnalyticsDataRanges.ORDER_ASEC, 
                                    homeAnalyticsDataRanges.ORDER_DESC];
            }
        });
        return formConfig;
    };
